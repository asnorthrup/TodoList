class TodoItemsController < ApplicationController
  ...
  # Removed TodoItems Index


  # GET /todo_items/1
  # GET /todo_items/1.json
  def show
    #no longer used, show through todo list then item
  end
  ...
  def edit
    #no longer used, edit through todo list then item
  end
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
        #if successful route to todolist index page
  ...
  private
      # Sets todo list instance variable from todo  list id passed in via params.
    def set_todo_list
